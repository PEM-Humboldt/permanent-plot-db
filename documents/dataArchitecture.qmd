...
```{r general, fig.height=15, fig.width=15}
par(mar=rep(0,4))
require(RPostgres)
require(dm)
...
Ahora bien, una parte de esas tablas soló sirve para controlar y definir las posibilidades en otras tablas (las tablas en rojo en la figura)
